...
local L = (function(tbl, defaultLocale)
	...
	["enUS"] = {
		...
		["Delete Profile"] = true,
		["Delete the current profile (not available for Default)"] = true,
		["Character Profile"] = true,
		["Set which profile this character uses"] = true,
		["(Use global default)"] = true,
		["Global Default Profile"] = true,
		["Set the default profile for characters with no specific assignment"] = true,
		["Enter a name for the new profile:"] = true,
		["Delete profile \"%s\"?"] = true,
		["Create"] = true,
	},
	["deDE"] = {},
	["esES"] = {},
