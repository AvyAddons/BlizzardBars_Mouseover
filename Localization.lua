...
local L = (function(tbl, defaultLocale)
	...
	["ruRU"] = {
        ...
        ["Show main action bar while skyriding. Requires a reload to take effect."] = "Показывать основную панель команд при полёте на драконе. Требуется перезагрузка интерфейса.",
        ["Always show the vehicle exit button when mounted on a vehicle or taxi. Requires a reload to take effect."] = "Всегда показывать кнопку выхода из транспорта (машина, такси и т.д.). Требуется перезагрузка интерфейса.",
        ...
        ["Transparency of the action bar when fully faded in"] = "Прозрачность панели команд в полностью видимом состоянии",
        ["Transparency of the action bar when fully faded out"] = "Прозрачность панели команд в полностью скрытом состоянии",		
	},
	["zhCN"] = {},
	["zhTW"] = {}
